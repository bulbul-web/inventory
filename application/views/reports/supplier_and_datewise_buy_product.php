   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>supplier-and-datewise-buy-product"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
...
<div class="col-lg-12">
  <div class="card">
      <div class="card-header">Supplier and datewise buy products</div>
    <div class="card-body">
        <?php echo form_open_multipart('supplier-and-datewise-buy-product', 'name="supplier-and-datewise-buy-product" id="supplierAndDatewiseBuyProduct" autocomplete="off"');?>
        <div class="row"> 
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <h5 style="text-align: center; text-decoration: underline;">Supplier and datewise buy product</h5>
