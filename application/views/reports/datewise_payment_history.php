   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>datewise-payment-history"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
...
<div class="col-lg-12">
  <div class="card">
      <div class="card-header">Datewise Payment History</div>
    <div class="card-body">
        <?php echo form_open_multipart('datewise-payment-history', 'name="datewise-payment-history" id="datewisePaymentHistory" autocomplete="off"');?>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <h5 style="text-align: center; text-decoration: underline;">Datewise Payment History</h5>
