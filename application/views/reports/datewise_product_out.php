...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
        <?php echo form_open_multipart('datewise-product-out', 'name="datewise-product-out" id="datewiseProductOut" autocomplete="off"');?>
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <h5 style="text-align: center; text-decoration: underline;">Product stock out by datewise</h5>
                ...
                <table width="100%" border="1" style="text-align: center;">
                    ...
                    <tbody>
                        <?php 
                            $sl=0;
                            foreach ($datewiseProductStockOut as $value):
                            $sl++
                        ?>
                        <tr>
                            <td><?= $sl;?></td>
