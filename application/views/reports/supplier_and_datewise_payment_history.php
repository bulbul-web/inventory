   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>supplier-and-datewise-payment-history"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
...
<div class="col-lg-12">
  <div class="card">
      <div class="card-header">Supplier and Datewise Payment History</div>
    <div class="card-body">
        <?php echo form_open_multipart('supplier-and-datewise-payment-history', 'name="supplier-and-datewise-payment-history" id="supplierAndDatewisePaymentHistory" autocomplete="off"');?>
        <div class="row"> 
            <div class="col-md-4">
                <div class="form-group row">
                    <label class="col-sm-12 col-form-label">Suppliers</label>
                    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <h5 style="text-align: center; text-decoration: underline;">Supplier and Datewise Payment History</h5>
                <center style="color: green; font-size: 18px; font-weight: bold;">
                    (<?php echo $singleSupplier->supplier_name;?>)<br>
                    Phone no: <?php echo $singleSupplier->supplier_mobile;?><br>
                    Address: <?php echo $singleSupplier->supplier_address;?><br>
                    <?php
