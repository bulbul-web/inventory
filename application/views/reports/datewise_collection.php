   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>datewise-collection"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
        <?php echo form_open_multipart('datewise-collection', 'name="datewise-collection" id="datewiseCollection" autocomplete="off"');?>
        <div class="row"> 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <h5 style="text-align: center; text-decoration: underline;">Datewise Collection</h5>
...
<a href="<?php echo base_url('all-report-section');?>" class="btn btn-secondary"><i class="fa fa-angle-left"></i> Back To Invoice List</a><br>
