...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    ...
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Add Products category</li>
    </ol>
    </div>
    <div class="col-sm-3">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-products-category', 'name="save-products-category" id="saveProductscategory"');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input category="text" name="name" value="<?php echo set_value('name'); ?>" class="form-control form-control-rounded">
