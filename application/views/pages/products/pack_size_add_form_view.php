        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-pack-size', 'name="save-pack-size" id="savePackSize"');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" placeholder="Pack size name" name="pack_size" value="<?php echo set_value('pack_size'); ?>" class="form-control form-control-rounded">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" placeholder="Pack size description" name="description" value="<?php echo set_value('description'); ?>"  class="form-control form-control-rounded">
                  </div>
                </div>
