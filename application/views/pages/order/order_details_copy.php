            ...
            <div class="div_style">
                <p style="text-align: center;"><?php echo $text?></p>
                    <table style="width: 100%; margin: 0 auto;">
                        <tr>
                            <td style="width: 30%; text-align: center;">
                                ...
                                <!-- <img src="<?php echo base_url().$companyInfo->file;?>" class="logo-icon" alt="logo icon" style="width: 70px;"></td> -->
								<?php
                    ...
                    <table  width="100%">
                        ...
                        <tr>
                            <td style="width: 50%;">
                                <p style="padding-left: 0px; line-height: 0px; margin-bottom: -4px;"> <?php echo $voucher_info_customer->entry_by?>  </p>
