...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        ...
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url().'edit-order/'.$voucher_info_customer->voucher_id;?>"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
   ...
   <div class="col-lg-12">
     <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('update-order', 'name="update-order" id="updateorder"');?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="hidden" name="order_by" value="<?php echo $voucher_info_customer->order_by;?>" />
                            ...
                            <table id="autocomplete_table" class="table table-bordered table-sm table-hover tbl-own" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row_<?=$i;?>">
                                        ...
                                        <td class="text-center"><a type="button" href="<?php echo base_url();?>delete-order-product/<?php echo $value->id;?>/<?=$value->voucher_id;?>" onclick="return confirm('Are you sure to remove?')" name="remove" data-row="row" scope="row" class="btn btn-danger btn-sm timesSpan">×</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
