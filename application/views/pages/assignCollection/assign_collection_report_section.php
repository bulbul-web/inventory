...
<div class="report-section">
    <div class="row">
        ...
        <div class="col-12 col-lg-6 col-xl-2">
            <a href="<?php echo base_url('datewise-assign-collection-report');?>">
                <div class="card bg-pattern-primary fxd-height">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body text-left">
                                <!-- <h4 class="text-white">ddd</h4> -->
                                <span class="text-white">Datewise Report</span>
                            </div>
        ...
        <div class="col-12 col-lg-6 col-xl-2">
            <a href="<?php echo base_url('customerwise-assign-collection-report');?>">
                <div class="card bg-pattern-primary fxd-height">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body text-left">
                                <!-- <h4 class="text-white">ddd</h4> -->
                                <span class="text-white">Customerwise Report</span>
                            </div>
                            <!-- <div class="align-self-center w-circle-icon rounded-circle bg-contrast">
