...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        ...
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('amount-recieved-common-customer-add');?>"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
   ...
   <div class="col-lg-12">
     <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-received-amount', 'name="save-received-amount" id="saveReceivedAmount"');?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input type="number" step=any name="recived_amount" value="0" class="form-control" required/>
                        </div>
                    </div>
                </div>
