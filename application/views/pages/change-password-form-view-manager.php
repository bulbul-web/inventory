        ...
        <div class="card-body">
            <center> 
                ...
                ?>
                    ...
                    <?php echo form_open_multipart('update-password-manager', 'name="update-password-manager" id="updatePasswordManager"');?>                       
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="hidden" name="id" value="<?php echo $singleManager->id;?>" >
                              <input type="hidden" name="user_id" value="<?php echo $singleManager->user_id;?>" >
                        ...
                        <div class="form-footer">
                            ...
                            <a class="btn btn-info" href="<?php echo base_url()?>manager-list"> Back</a>
