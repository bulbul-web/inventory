...
<div class="row">
   <div class="col-lg-12">
     <div class="card">
        <div class="card-header text-uppercase">Add Expense Form</div>
        <div class="card-body">
            <center> 
            ...
            <?php echo form_open('save-expense', 'name="save-expense" id="saveExpense"');?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" placeholder="Date" name="trnsction_date" id="datepicker" value="<?php echo date('Y-m-d'); ?>" class="form-control form-control-rounded">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" placeholder="Note" name="note" class="form-control form-control-rounded">
                        </div>
                      </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <table id="autocomplete_table" class="table table-bordered table-sm table-hover tbl-own" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr id="row_1">
                                    <td>
                                        <input type="text" name="trnsaction_head" id="trnsaction_head_1" placeholder="type expense name" class="form-control autocomplete_txt" required="">
                                        <input type="hidden" name="id[]" id="id_1" required="">
                                    </td>
                                    <td><input type="number" step=any name="amount[]" onkeyup="amountPress(this)" id="amount_1" value="0" class="form-control" required=""></td>
