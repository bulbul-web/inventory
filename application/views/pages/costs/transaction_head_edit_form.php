...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    ...
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active" aria-current="page">Update Transaction Head</li>
    </ol>
    </div>
    <div class="col-sm-3">
...
<div class="row">
   <div class="col-lg-12">
     <div class="card">
        <div class="card-header text-uppercase">Update Transaction Head Form</div>
        <div class="card-body">
            <center> 
            ...
            <?php echo form_open_multipart('update-transaction-head', 'name="update-transaction-head" id="updateTransactionHead"');?>
...
<script>
    document.forms['update-transaction-head'].elements['status'].value=<?php echo $singleCostsHead->status; ?>;//for active inactive.
</script>