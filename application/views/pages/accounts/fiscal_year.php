...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    <h4 class="page-title">Fiscal Year</h4>
    <ol class="breadcrumb">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('fiscal-year-add');?>"><i aria-hidden="true" class="fa fa-plus-circle"></i> Add Fiscal Year</a>
        </div>
    ...
    <div class="card-body">
      ...
      <!-- <table id="example" class="table table-bordered">
        ...
        <tbody>
            ...
            <?php 
                $i = 0;
                foreach ($allFiscalYear as $value){
                    $i++;
