...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    <h4 class="page-title">All Sub Sub Head</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url();?>">Dashboard</a></li>
       <li class="breadcrumb-item active" aria-current="page">All Sub Sub Head</li>
    </ol>
    </div>
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('account-sub-sub-head-add');?>"><i aria-hidden="true" class="fa fa-plus-circle"></i> Add Sub Sub Head</a>
        </div>
      ...
      <div class="table-responsive">
        <table id="example" class="table table-bordered">
            ...
            <tbody>
                ...
                <?php 
                    $i = 0;
                    foreach ($allAccountSubSubHead as $value){
                        $i++;
