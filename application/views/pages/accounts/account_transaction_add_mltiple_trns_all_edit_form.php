            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" placeholder="Transaction date" name="TrnDate" id="datepicker" value="<?php echo $transactionAcntRow->TrnDate; ?>" class="form-control form-control-rounded" required="">
