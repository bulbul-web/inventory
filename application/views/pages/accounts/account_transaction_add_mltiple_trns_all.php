   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>account-transaction-add"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
   ...
   <div class="col-lg-12">
     <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo form_open_multipart('save-acnt-tansaction-mltple-trns-all', 'name="save-acnt-tansaction-mltple-trns-all" id="saveAcntTansactionMltpleTrnsAll"');?>
