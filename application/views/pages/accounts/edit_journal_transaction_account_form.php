...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    <h4 class="page-title">Update Journal Tansaction</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?php echo base_url();?>">Dashboard</a></li>
       <li class="breadcrumb-item active" aria-current="page">Update Journal Tansaction</li>
    </ol>
    </div>
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url();?>edit-journal-transaction-account/<?php echo $transactionAcntRow->VoucherNo;?>"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
     </div>
</div>
<!-- End Breadcrumb-->
...
<div class="row">
   <div class="col-lg-12">
     <div class="card">
        <div class="card-header text-uppercase">Update Journal Tansaction Form <span style="color: red;"><?php echo $transactionAcntRow->VoucherNo;?></span></div>
        <div class="card-body">
            <center> 
            ...
            <?php echo form_open_multipart('update-acnt-journal-tansaction-mltple-trns-all', 'name="update-acnt-journal-tansaction-mltple-trns-all" id="updateAcntJournalTansactionMltpleTrnsAll"');?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="TrnDate" id="datepicker" value="<?php echo $transactionAcntRow->TrnDate; ?>" class="form-control form-control-rounded" required="" placeholder="Transaction date">
                ...
                <input type="hidden" name="J_V_Type" value="<?php echo $transactionAcntRow->V_Type; ?>" />
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <select name="V_Type" id="V_Type" class="form-control" required="">
                                ...
                                <option value="DR" <?php if ($transactionAcntRow->CR != 0): ?> selected <?php endif; ?> >DR</option>
                                <option value="CR" <?php if ($transactionAcntRow->DR != 0): ?> selected <?php endif; ?> >CR</option>
                            </select>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" placeholder="Note" name="Note" class="form-control" value="<?php echo $transactionControlHead->Note;?>">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.forms['update-acnt-journal-tansaction-mltple-trns-all'].elements['project_id'].value=<?php echo $transactionAcntRow->project_id; ?>;
    document.forms['update-acnt-journal-tansaction-mltple-trns-all'].elements['TrasactionHeadID'].value=<?php echo $transactionControlHead->TrasactionHeadID; ?>;
</script>
<script>
