...
<div class="row pt-2 pb-2">
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        ...
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('salesman-order');?>"><i aria-hidden="true" class="fa fa-arrow-left"></i> Back</a>
        </div>
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url().'edit-salesman-order/'.$order_info_customer->order_id;?>"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
...
<div class="row">
   <div class="col-lg-12">
     <div class="card">
        <div class="card-header text-uppercase">Update order ID: <span style="color: red;"><?php echo $order_info_customer->order_id;?></span>
            <span style="margin-left: 15px; color: green;">
                ----> <?php
                    $payment_day = $order_info_customer->payment_day;
                    $date1 = $order_info_customer->entry_date;
                    $date2 = date('Y-m-d');
        ...
        <div class="card-body">
            ...
            <?php echo form_open('update-salesman-order', 'name="update-salesman-order" id="updateSalesmanOrder"');?>
                
<!--            <label>Order ID:</label><input type="text" name="orderId_manual" value=""/>-->
                <?php
                    //$total_row_array = count($order_info_customer, COUNT_RECURSIVE);
                ?>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="customer_name" id="customer_name" value="<?php echo $order_info_customer->customer_name;?>" placeholder="type customer name"  class="form-control form-control-rounded">
                            <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $order_info_customer->customer_id;?>"  class="form-control form-control-rounded">
                            
                            <input type="hidden" name="order_id" value="<?php echo $order_info_customer->order_id;?>" />
                            <input type="hidden" name="order_by" value="<?php echo $order_info_customer->order_by;?>" />
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" id="customer_mobile" value="<?php echo $order_info_customer->customer_mobile;?>" class="form-control form-control-rounded" disabled="">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="email" id="customer_email" value="<?php echo $order_info_customer->customer_email;?>" class="form-control form-control-rounded" disabled="">
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" id="customer_address" value="<?php echo $order_info_customer->customer_address;?>" class="form-control form-control-rounded" disabled="">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="order_date" id="datepicker" value="<?php echo $order_info_customer->order_date;?>" class="form-control form-control-rounded">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="note" value="<?php echo $order_info_customer->note;?>" class="form-control form-control-rounded">
                        </div>
                      </div>
                    </div>
                        ...
                        <div style="overflow-x:auto; width: 100%;">
                            <table id="autocomplete_table" class="table table-bordered table-sm table-hover tbl-own" style="width: 100%;">
                                ...
                                <tbody>
                                    <?php 
                                        $i = 0;
                                        foreach($order_info_product as $value):
                                        $i++;
                                    ?>
                                    <tr id="row_<?=$i;?>">
                                        <td>
                                        ...
                                        <td class="text-center"><a type="button" href="<?php echo base_url();?>delete-salesman-order-product/<?php echo $value->id;?>/<?=$value->order_id;?>" onclick="return confirm('Are you sure to remove?')" name="remove" data-row="row" scope="row" class="btn btn-danger btn-sm timesSpan">×</a></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
