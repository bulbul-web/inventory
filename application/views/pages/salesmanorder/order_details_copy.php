            ...
            <div class="div_style">
                <p style="text-align: center;"><?php echo $text?></p>
                        ...
                        <tr>
                            ...
                            <td style="width: 50%;">
                                <table width="100%" class="customer_section">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><b><?php echo $order_info_customer->customer_name;?></b></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><?php echo $order_info_customer->customer_email;?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table  width="100%">
                        ...
                        <tr>
                            <td style="width: 50%;">
                                <p style="padding-left: 0px; line-height: 0px; margin-bottom: -4px;"> <?php echo $order_info_customer->entry_by?>  </p>
