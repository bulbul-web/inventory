   ...
   <div class="col-sm-9">
    ...
    <div class="col-sm-3">
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('salesman-order');?>"><i aria-hidden="true" class="fa fa-list"></i> Order list</a>
        </div>
        <div class="top-button-area">
            <a class="btn btn-primary m-1" href="<?php echo base_url('salesman-order-form');?>"><i class="fa fa-retweet" aria-hidden="true"></i></a>
        </div>
    </div>
</div>
<!-- End Breadcrumb-->
   ...
   <div class="col-lg-12">
     <div class="card">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-salesman-order', 'name="save-salesman-order" id="savesalesmanorder"');?>
           <!-- <label>Order ID:</label><input type="text" class="form-control form-control-rounded" name="orderId_manual" value="" required="required"/> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="order_date" id="datepicker" value="<?php echo date('Y-m-d'); ?>" class="form-control form-control-rounded">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="overflow-x:auto;">
                            <table name="save-salesman-order" id="autocomplete_table" class="table table-bordered table-sm table-hover tbl-own" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Product Name</th>
                                        <th>Quantity</th>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <button id="addorderItem" name="add-salesman-order-item" type="button" class="btn btn-primary btn-sm">Add New Item</button>
                                        </td>
                                    </tr> 
                                    <tr>
                ...
                <div class="form-footer">
                    <a href="<?php echo base_url('salesman-order-form');?>" class="btn btn-secondary"><i class="fa fa-times"></i> Cancel</a>
