  ...
  <div class="card">
    ...
    <div class="card-body" id="divid">
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td colspan="2" style="text-align: left;">
                    <h4 style="margin: 0; padding: 0;"><?php echo $order_info_customer->order_id; ?></h4>
                </td>
            </tr>
            <tr>
                <td width="10%" style="text-align: left;">Issue Date:</td>
                <td style="text-align: left;"><?php echo $order_info_customer->order_date;?></td>
            </tr>
        </table>
        <table width="100%">
            <tr>
            ...
            <tr>
                <td width="70%">&nbsp;</td>
                <td class="text-left"><b><?php echo $order_info_customer->customer_name;?></b></td>
            </tr>
            <tr>
                <td width="70%">&nbsp;</td>
                <td class="text-left"><?php echo $order_info_customer->customer_address;?></td>
            </tr>
            <tr>
                <td width="70%">&nbsp;</td>
                <td class="text-left"><?php echo $order_info_customer->customer_mobile;?></td>
            </tr>
            <tr>
                <td width="70%">&nbsp;</td>
                <td class="text-left"><?php echo $order_info_customer->customer_email;?></td>
            </tr>
        </table>
