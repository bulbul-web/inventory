        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-warehouse', 'name="save-warehouse" id="saveWarehouse"');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" name="warehouse_name" value="<?php echo set_value('warehouse_name'); ?>" class="form-control form-control-rounded">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" name="warehouse_address" value="<?php echo set_value('warehouse_address'); ?>"  class="form-control form-control-rounded">
