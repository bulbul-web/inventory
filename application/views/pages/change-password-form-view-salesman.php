        ...
        <div class="card-body">
            <center> 
                ...
                ?>
                    ...
                    <?php echo form_open_multipart('update-password-salesman', 'name="update-password-salesman" id="updatePasswordSalesman"');?>                       
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="hidden" name="id" value="<?php echo $singleSalesman->id;?>" >
                              <input type="hidden" name="user_id" value="<?php echo $singleSalesman->user_id;?>" >
                        ...
                        <div class="form-footer">
                            ...
                            <a class="btn btn-info" href="<?php echo base_url()?>salesman-list"> Back</a>
