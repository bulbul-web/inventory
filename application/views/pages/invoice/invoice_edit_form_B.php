                    ...
                    <div class="col-md-12">
                        <table id="autocomplete_table" class="table table-bordered table-sm table-hover tbl-own" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr id="row_<?=$i;?>">
                                    <td>
                                        <input type="text" name="product_name" onchange="productPress(this)" id="product_name_<?=$i;?>" value="<?php echo $value->product_name;?>" placeholder="type product name" class="form-control autocomplete_txt">
                                        <?php echo form_error('product_name', '<div class="error">', '</div>'); ?>
                                        <input type="hidden" name="product_id[]" value="<?php echo $value->product_id;?>" id="product_id_<?=$i;?>">
