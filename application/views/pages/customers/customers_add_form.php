        ...
        <div class="card-body">
            ...
            <?php echo form_open('save-customers', 'name="save-customers" id="saveCustomers"');?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" placeholder="Customer name" name="customer_name" value="<?php echo set_value('customer_name'); ?>" class="form-control form-control-rounded">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" placeholder="Customer address" name="customer_address" value="<?php echo set_value('customer_address'); ?>"  class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Customer Mobile</label>
                  <div class="col-sm-9">
                      <input type="text" placeholder="Customer Mobile" name="customer_mobile" value="<?php echo set_value('customer_mobile'); ?>" class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Customer Email</label>
                  <div class="col-sm-9">
                      <input type="email" placeholder="Customer Email" name="customer_email" value="<?php echo set_value('customer_email'); ?>" class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Contact Person Name</label>
                  <div class="col-sm-9">
                      <input type="text" placeholder="Contact person name" name="contact_person_name" value="<?php echo set_value('contact_person_name'); ?>" class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Contact Person Mobile</label>
                  <div class="col-sm-9">
                      <input type="text" placeholder="Contact person mobile" name="contact_person_mobile" value="<?php echo set_value('contact_person_mobile'); ?>" class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Contact Person Email</label>
                  <div class="col-sm-9">
                      <input type="email" placeholder="Contact person email" name="contact_person_email" value="<?php echo set_value('contact_person_email'); ?>" class="form-control form-control-rounded">
                  </div>
                </div>
                <div class="form-group row">
